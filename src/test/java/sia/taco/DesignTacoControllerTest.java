...
public class DesignTacoControllerTest {
  ...
  public void setup() {
    ...
    when(ingredientRepository.findById("FLTO").get()).thenReturn(new Ingredient("FLTO", "Flour Tortilla", Type.WRAP));
    when(ingredientRepository.findById("GRBF").get()).thenReturn(new Ingredient("GRBF", "Ground Beef", Type.PROTEIN));
    when(ingredientRepository.findById("CHED").get()).thenReturn(new Ingredient("CHED", "Cheddar", Type.CHEESE));
